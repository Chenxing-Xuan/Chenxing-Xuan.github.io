...
$$ 
\eta_{eff}=\frac{ \eta }{\|w\|_F} 
$$ 

将每一步更新看作更新整个模型的百分比看作更新步长，那么我们可以通过先运行 $w^2$ 的实验，并且记录下来 $w^2$ 实验中每一步更新的有效学习率 $ \eta_{eff,t}^2=\frac{\eta_t}{\|w^2_t\|}_F $ 。并在运行 $ w^1 $ 的更新过程中，通过只进行对学习率进行标量乘法来让两者的有效学习率做对齐。
